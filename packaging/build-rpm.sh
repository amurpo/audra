...
cp "$ROOT/data/io.github.amurpo.audra.desktop"                             "$RPMBUILD/SOURCES/"
cp "$ROOT/data/io.github.amurpo.audra.metainfo.xml"                        "$RPMBUILD/SOURCES/"
cp "$ROOT/data/icons/hicolor/scalable/apps/io.github.amurpo.audra.svg"    "$RPMBUILD/SOURCES/"
